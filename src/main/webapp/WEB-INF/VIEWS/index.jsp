                    ...
                    <div class="text-center text-white">
                        ...
                        <form>
                            <div class="input-group input-group-lg">
                                <input class="form-control" type="text" placeholder="제목을 입력해주세요..." aria-label="Enter Book Title..." aria-describedby="button-submit" />
                                <button class="btn btn-primary" id="button-submit" type="button" onclick="location.href='#bookSearch' ">검색</button>
                                <button class="btn btn-primary" id="button-detail-submit" type="button" onclick="location.href='#bookDetailSearch' ">상세 검색</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="card text-center">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" id="tabs">
                        <li class="nav-item">
                            <a class="nav-link active" href="#librarianNominate" data-toggle="tab">사서 추천 도서</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#newBook" data-toggle="tab">신간 도서</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#collection" data-toggle="tab">컬렉션</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="librarianNominate">
                            ...
                            <div class="card text-white bg-primary my-5 py-10 text-center">
                                <div class="card-body">
                                    <a href="#libralianFreeBoard" class="btn btn-primary btn-lg">사서 추천 도서 게시판</a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="newBook">
                            ...
                            <div class="card text-white bg-primary my-5 py-10 text-center">
                                <div class="card-body">
                                    <a href="#newBookFreeBoard" class="btn btn-primary btn-lg">신간 도서 게시판</a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="collection">
                            ...
                            <div class="card-group">
                                <div class="card" style="width: 18rem;">
                                    <img class="card-img-top" src="assets/img/testimonials-3.jpg" alt="Card image cap">
                                    <div class="card-body">
                            ...
                            <div class="card text-white bg-primary my-5 py-10 text-center">
                                <div class="card-body">
                                    <a href="#collectionFreeBoard" class="btn btn-primary btn-lg">컬렉션 게시판</a>
                                </div>
                            </div>
                        </div>
                    </div>
