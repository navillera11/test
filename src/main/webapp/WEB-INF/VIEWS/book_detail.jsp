    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="assets/img/1.jpg" alt="..." /></div>
                <div class="col-md-6">
                    <div class="small mb-1">있어보이는 도서 장르 똬돻</div>
                    <h1 class="display-5 fw-bolder">도서 제목</h1>
                    <div class="fs-5 mb-5">
                    ...
                    <p class="lead">
                        ...
                        출판사 : 블라블라
                        <br/>
                        대충 있어보이는 문구 하나 추가하고 싶은데 그러려면 도서 테이블에 속성 추가해야함
                    </p>
                    <div class="d-flex">
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">도서 상세</a></div>
                        </div>
                    </div>
                </div>
                <div class="col mb-5">
