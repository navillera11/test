                    ...
                    <div class="card-body">
                        <form action="/admin/alarm/good/good_delete" method="POST">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="inputGoodID" type="text" placeholder="추천 도서 게시물의 ID 입력해주세요." name="inputGoodID" />
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="inputGoodTitle" type="text" placeholder="제목 명을 입력하십시오." name="inputGoodTitle" /> <label for="inputGoodTitle">제목</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="inputGoodTitleConfirm" type="text" placeholder="제목이 맞는지 확인하십시오." name="inputGoodTitleConfirm" /> <label for="inputGoodTitleConfirm">제목 확인</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 mb-0">
                                <div class="d-grid">
                                    <input type="submit" class="btn btn-primary btn-block" value="추천 도서 게시물을 삭제합니다." />
                                </div>
                            </div>
                        </form>
                    </div>
