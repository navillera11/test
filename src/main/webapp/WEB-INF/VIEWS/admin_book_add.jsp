								...
								<form action="/admin/book/add" method="POST">
										...
										<div class="col-md-6">
											<div class="form-floating mb-3 mb-md-0">
												<input class="form-control" id="inputBookISBN" type="text"
													placeholder="ISBN 코드를 입력해주세요." name="inputBookISBN" /> <label
													for="inputISBN">ISBN10 코드</label>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-floating">
												<input class="form-control" id="inputBookGenre" type="text"
													placeholder="장르를 입력해주세요." name="inputBookGenre" /> <label
													for="inputGenre">장르</label>
											</div>
										</div>
									</div>
										...
										<div class="col-md-4">
											<div class="form-floating mb-3 mb-md-0">
												<input class="form-control" id="inputBookTitle" type="text"
													placeholder="제목 명을 입력해주세요." name="inputBookTitle" /> <label
													for="inputFirstName">제목</label>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-floating mb-3 mb-md-0">
												<input class="form-control" id="inputBookAuthor" type="text"
													placeholder="저자 명을 입력해주세요." name="inputBookAuthor" /> <label
													for="inputLastName">저자</label>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-floating mb-3 mb-md-0">
												<input class="form-control" id="inputBookPublisher"
													type="text" placeholder="출판사 명을 입력해주세요."
													name="inputBookPublisher" /> <label for="inputLastName">출판사</label>
											</div>
										</div>
									</div>
									...
									<div class="form-floating mb-3">
										<input class="form-control" id="inputBookCount" type="number"
											placeholder="권수를 입력해주세요." name="inputBookCount" /> <label
											for="inputBookCount">권수</label>
									</div>

									<!--                                    파일-->
									<label class="form-label" for="inputBookImage">책의 이미지
										파일을 삽입해주세요.</label> <input class="form-control" id="inputBookImage"
										type="file" placeholder="이미지 파일을 선택해주세요."
										name="inputBookImage" />
